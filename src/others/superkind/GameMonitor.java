 ...
 * SuperKind game.  A GameMonitor will only call the Super Kind
...
public final class GameMonitor implements GameObserver {
    ...
    public GameMonitor(String name, GameModel model) {
        ...
        frame.addWindowListener(new WindowAdapter() {
            @Override public void windowClosing(WindowEvent e) {
                GameMonitor.this.handleWindowClosing();
            }
        });
        frame.add(component);
        this.model = model;
    ...
    public void update() {
        try {
            // NOTE:  Querying the model's state here is a little weird.
            //        See the warning at the beginning of this file.
