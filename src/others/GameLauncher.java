...
/**
 * Interface describing objects that are used to launch games.
 * These launchers are used by main to launch any number of different
 * games in the same program.
 */
public interface GameLauncher {


    /**
     * The name of the game this object launches.  It must end with 
     * a colon.  
     */
     ...
     * game(s), or it may return immediately (after arranging play to occur
     * on some other thread or threads).
     *
