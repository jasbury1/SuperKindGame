...
import superkind.SuperKindGameLauncher;

public class Main {


    private static GameLauncher[] launchers = { new SuperKindGameLauncher() };
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < games.size(); i++) {
            ...
            Thread t = new Thread(() -> { runGame(launcher, launcherArgs); }, threadName);
            t.start();
        }
    }
